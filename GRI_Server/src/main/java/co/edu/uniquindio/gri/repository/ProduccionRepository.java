...
public interface ProduccionRepository extends JpaRepository<Produccion, Long> {
	...
	// Facultades
	/**
	 * Obtiene la producción bibliográfica de una facultad con respecto a sus programas.
	 *
	...
	/**
	 * Obtiene la producción bibliográfica de una facultad con respecto a sus centros.
	 *
	 * @param entityId el id de la facultad
	 * @param tipoId el tipo de la producción 
	 * @return lista de producciones bibliográficas del tipo tipoId.
	...
	/**
	 * Obtiene las producciones bibliográficas contenidas en los GrupLAC de los grupos de acuerdo a una cadena de búsqueda.
	 *
	 * @param cadena la cadena de búsqueda
	 * @return lista de producciones biblográficas correspondientes con la cadena de búsqueda.
	 */
	//Grupos
	...
	//Investigadores
	/** 
	 * Obtiene las producciones bibliográficas contenidas en los CvLAC de los investigadores de acuerdo a una cadena de búsqueda.
	 *
	 * @param cadena la cadena de búsqueda
	 * @return lista de producciones biblográficas correspondientes con la cadena de búsqueda.
	 */
